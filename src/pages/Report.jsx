            ...
            <div className="details">
              <div className="topinf0">
                <div className="py-[5px]">
                  ...
                  <input type="text" value={`${res.idno}`} id='stdID' className='border-[1px] border-[#f00]' onChange={handleID}/>
                </div>
                <div className="py-[5px]">
              ...
              <div className="applicantsinfo flex flex-col gap-1 border-[1px] border-[#700] p-[5px]">
                ...
                <div className="w-full flex">
                  ...
                  <div className="bx w-[80%]">
                    <input type="text" value={`${res.name}`} id='stdName' className='border-b-[1px] border-[#f00] border-dotted w-full px-[10px]'/>
                  </div>
                </div>
                <div className="w-full flex">
                  <div className="lbl w-[20%]">
                  ...
                  <div className="bx w-[80%]">
                    <input type="text" value={`${res.fathername}`} id='stdFName' className='border-b-[1px] border-[#f00] border-dotted w-full px-[10px]'/>
                  </div>
                </div>
                <div className="w-full flex">
                  <div className="lbl w-[20%]">
                  ...
                  <div className="bx w-[80%]">
                    <input type="text" value={`${res.mothername}`} id='stdMName' className='border-b-[1px] border-[#f00] border-dotted w-full px-[10px]'/>
                  </div>
                </div>
                <div className="w-full flex items-end">
                  ...
                  <div className="bx w-[80%]">
                    <input type="text" value={`${res.presentaddress}`} id='stdPaddres' className='border-b-[1px] border-[#f00] border-dotted w-full px-[10px]'/>
                  </div>
                </div>
                <div className="w-full flex items-end">
                  <div className="lbl w-[20%]">
                  ...
                  <div className="bx w-[80%]">
                    <input type="text" value={`${res.permanentaddress}`} id='stdPraddres' className='border-b-[1px] border-[#f00] border-dotted w-full px-[10px]'/>
                  </div>
                </div>
                <div className="w-full flex">
                  ...
                  <div className="w-1/2 flex gap-5">
                    ...
                    <div className="bx flex gap-5">
                      <input type="text" value={`${res.gender}`} />
                    </div>
                  </div>
                </div>
                <div className="w-full flex">
